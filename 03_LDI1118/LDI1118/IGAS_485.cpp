...
//	Serial1.begin(9600, SERIAL_8N1);
	...
	interframe_delay = 40000/COMM_BAUD;
}


uint8_t IGAS_X2X_485::update()
{
	int8_t		length = Serial.available();
...
************************************************************************/
int IGAS_X2X_485::write_regs(uint16_t start_addr, uint8_t * query, int * regs)
{
	int temp = 0;
	uint16_t i = 0;
...
*************************************************************************/
int IGAS_X2X_485::preset_multiple_registers(uint8_t slave, uint16_t start_addr, uint8_t count, uint8_t * query, int * regs)
{
...
*************************************************************************/
int IGAS_X2X_485::write_single_register(uint8_t slave, uint16_t write_addr, uint8_t * query, int * regs)
{
...
*************************************************************************/
int IGAS_X2X_485::read_holding_registers(uint8_t slave, uint16_t start_addr, uint8_t reg_count, int * regs)
{
