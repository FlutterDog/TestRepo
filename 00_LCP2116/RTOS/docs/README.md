...
> ⚠️ **Внимание**
>
> Блокирующая функция внутри основной задачи останавливает обслуживание X2X, FieldSensor, Ethernet, RTC, служебной консоли и watchdog на всё время ожидания. Не допускаются длительные `delay`, busy-wait и циклы ожидания аппаратного события без timeout.
