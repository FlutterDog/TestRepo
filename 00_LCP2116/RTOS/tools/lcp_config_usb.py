#!/usr/bin/env python3
"""Lorentz LCP2116 USB configuration utility.

The protocol, schema-v1 configuration model, legacy TXT compatibility and JSON
import/export are implemented by the private core module. This user-facing CLI
adds robust Windows usbser.sys handling:

* retry opening a CDC port while an old handle is being removed;
* wait briefly for both CDC directions after opening;
* retry HELLO for a bounded deadline after a transient serial error;
...
import _lcp_config_usb_core as core
