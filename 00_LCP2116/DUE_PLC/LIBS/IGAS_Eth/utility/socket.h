...
extern uint8_t connect(SOCKET s, uint8_t * addr, uint16_t port); // Establish TCP Connected (Active Connected)
extern void disconnect(SOCKET s); // disconnect the Connected
extern uint8_t listen(SOCKET s);	// Establish TCP Connected (Passive Connected)
