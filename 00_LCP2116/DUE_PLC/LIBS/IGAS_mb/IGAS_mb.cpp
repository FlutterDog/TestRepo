...
unsigned int IGAS_mb_485::crc(unsigned char * buf, unsigned char start,
                              unsigned char cnt)
{
    unsigned char i, j;
...
int IGAS_mb_485::modbus_request(unsigned char slave, unsigned char * data)
{
...
int IGAS_mb_485::read_holding_registers(unsigned char slave, unsigned int start_addr,
...
void IGAS_mb_485::setDelegate(void (*fp)(int*,  int,  int, int ) )
{
    fpAction = fp;
}


void IGAS_mb_485::doAction(int *t1, int t2,int t3, int t4)
{
