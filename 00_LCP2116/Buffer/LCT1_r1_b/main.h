...
#define	DDR_DI				DDRA
#define	PORT_DI				PORTA
#define	PIN_DI				PINA

#define	DDR_485				DDRA
#define	PORT_485			PORTA
#define PIN_RS_Enable		PIND4


#define LED_PLC_OK			PINE5
#define LED_SD_OK			PINE6
#define LED_X2X_OK			PINE7
#define	Channel1			LED_SD_OK
#define	Channel2			LED_PLC_OK
...
#define PIN_DI_1			PINA5
#define PIN_DI_2			PINA4
#define PIN_DI_3			PINA3
#define PIN_DI_4			PINA2
#define PIN_DI_5			PINA1
#define PIN_DI_6			PINA0

#define MASK_DI_1			0b00100000
#define MASK_DI_2			0b00010000
#define MASK_DI_3			0b00001000
#define MASK_DI_4			0b00000100
#define MASK_DI_5			0b00000010
#define MASK_DI_6			0b00000001
...
#define OSC_REC_PERIOD		200

//#define MAX_REGISTER_ID		2001
...
enum breakerState {
	cb_NA,      // Both bits 0, but none was 1 before
	cb_On_Off,  // Breaker was On and now switching off
	cb_Off_On,  // Breaker was Off and now turning off
	cb_Off,     // Breaker is OFF
	cb_On       // Breaker is On
};
...
#define PIN_ADC_AI1			PORTE
#define PIN_ADC_AI2			PORTF
