...
---
![Build specs installer view](img/find_event_case.png)
---   
2. Найти двойным кликом по кнопке соответствующий Event ;
---
![Build specs installer view](img/confirm_event_case.png)
--- 
3. дублировать выбранный Event Case и настроить на скопированные кнопки и окна интерфейса;
---
![Build specs installer view](img/Duplicate.png)
---   
4. На главном экране переместить новые скопированные детали интерфейса на нужные места;
---
![Build specs installer view](img/Align_New.png)
--- 

6. обновить **Event Catalog** (ID/назначение/класс операции).
