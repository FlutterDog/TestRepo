...
uint8_t twi_writeTo(uint8_t address, uint8_t* data, uint8_t length, uint8_t wait, uint8_t sendStop)
{
	...
	// wait for write operation to completed
	...
	// Старт Заменили на обработку с таймаутом - если I2C отвалилась
// 	unsigned long t0 = millis();
// 	while(wait && (TWI_MTX == twi_state)){
// 		if (millis() - t0 > 10) { // 10 мс таймаут
// 			twi_state = TWI_READY;
// 			twi_error = 0xF0; // код ошибки таймаута (можно свой)
// 			return 5;
// 		}
// 	// ФИН Заменили на обработку с таймаутом - если I2C отвалилась
