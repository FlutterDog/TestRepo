...
extern const volatile uint8_t slave_default_address;
...
void settings()
{
	...
	densitySet = 617;  // addr 104-105, def 617 - SF6

	gasPartner =  0;
	// Serial number
	serialLow = 0xAAAA;  // addr 106-107, def FFFF - Year
	serialHigh = 0xAAAA;  // addr 108-109, def FFFF - Number
	
	
	//hVersion = loadByte(110, 0xFF);  // addr 110, def FF
	// sVersion = loadByte(111, 0xFF);  // addr 111, def FF
	modelDN = 0;		// addr 112, def 0 - DN910 non humidity
	getTempFromSHT = 0;		// addr 113, def 0 - DN910 read Temperature from pressure sensor
