...
- [1. Введение](#sec-1)
  - [1.1. Исходные данные](#sec-1-1)
  - [1.2. Нормативная и конструкторская база](#sec-1-2)
  - [1.3. Границы документа](#sec-1-3)
- [2. Назначение и область применения системы](#sec-2)
- [3. Состав системы и функциональное назначение модулей](#sec-3)
  - [3.1. Общая архитектура](#sec-3-1)
  - [3.2. Процессорный модуль LCP2116](#sec-3-2)
  - [3.3. Модуль аналоговых входов LAI1118](#sec-3-3)
  - [3.4. Модуль дискретных входов LDI1118](#sec-3-4)
  - [3.5. Модуль релейных выходов LDO1128](#sec-3-5)
- [4. Конструктивное исполнение](#sec-4)
  - [4.1. Корпус и установка на DIN-рейку](#sec-4-1)
  - [4.2. Съёмные клеммные блоки и Push-In подключение](#sec-4-2)
  - [4.3. Печатные платы и сборочный состав](#sec-4-3)
  - [4.4. Лицевая панель и светодиодная индикация](#sec-4-4)
- [5. Электрическая архитектура и интерфейсы](#sec-5)
  - [5.1. Питание](#sec-5-1)
  - [5.2. Внутренняя шина X2X](#sec-5-2)
  - [5.3. RS485, Ethernet и USB процессорного модуля](#sec-5-3)
  - [5.4. Аналоговые входы LAI1118](#sec-5-4)
  - [5.5. Дискретные входы LDI1118](#sec-5-5)
  - [5.6. Релейные выходы LDO1128](#sec-5-6)
- [6. Габаритные и компоновочные данные](#sec-6)
  - [6.1. Расчёт занимаемой ширины на DIN-рейке](#sec-6-1)
- [7. Монтаж, ЭМС и заземление](#sec-7)
  - [7.1. Установка модулей](#sec-7-1)
  - [7.2. Электромагнитная совместимость](#sec-7-2)
  - [7.3. Защита от электростатических разрядов](#sec-7-3)
  - [7.4. Защита от перенапряжений](#sec-7-4)
- [8. Механическая и электрическая конфигурация](#sec-8)
  - [8.1. Потенциальные группы](#sec-8-1)
  - [8.2. Безопасное отключение потенциальной группы](#sec-8-2)
  - [8.3. Расчёт питания](#sec-8-3)
- [9. Диагностика, обслуживание и ремонтопригодность](#sec-9)
- [10. Программное обеспечение и конфигурирование](#sec-10)
- [11. Безопасность применения](#sec-11)
- [12. Кибербезопасность и защита конфигурации](#sec-12)
- [13. Условия эксплуатации, хранения и утилизации](#sec-13)
- [14. Оценка принятых технических решений](#sec-14)
- [15. Заключение](#sec-15)
- [16. Перечень использованных документов](#sec-16)
- [Приложение А. Сводная таблица технических параметров](#app-а)
- [Приложение Б. Перечень данных для уточнения перед выпуском](#app-б)
...
<a id="sec-1-2"></a>
## 1.2. Нормативная и конструкторская база
...
*Рисунок 2 — Структура системы Lorentz.*
...
*Рисунок 3 — Процессорный модуль LCP2116.*

![Интерфейсы и индикация LCP2116](img/lcp2116_interfaces.png){width=75%}

*Рисунок 4 — Интерфейсы и индикация LCP2116.*
...
*Рисунок 5 — Интерфейсы и индикация LAI1118.*
...
*Рисунок 6 — Модуль дискретных входов LDI1118.*
...
*Рисунок 7 — Модуль релейных выходов LDO1128.*
...
*Рисунок 8 — Конструкция модуля Lorentz.*
...
*Рисунок 9 — Подключение модулей по X2X.*

<a id="sec-5-3"></a>
## 5.3. RS485, Ethernet и USB процессорного модуля
...
*Рисунок 10 — Габаритный чертёж LCP2116.*

![Габаритный чертёж LAI1118](img/lai1118_dimensions.png){width=85%}

*Рисунок 11 — Габаритный чертёж LAI1118.*

![Габаритный чертёж LDI1118](img/ldi1118_dimensions.png){width=85%}

*Рисунок 12 — Габаритный чертёж LDI1118.*

![Габаритный чертёж LDO1128](img/ldo1128_dimensions.png){width=85%}

*Рисунок 13 — Габаритный чертёж LDO1128.*

<a id="sec-6-1"></a>
## 6.1. Расчёт занимаемой ширины на DIN-рейке
...
<a id="sec-7-2"></a>
## 7.2. Электромагнитная совместимость
...
*Рисунок 14 — Прокладка кабелей и ЭМС.*

<a id="sec-7-3"></a>
## 7.3. Защита от электростатических разрядов
...
<a id="sec-8"></a>
# 8. Механическая и электрическая конфигурация

<a id="sec-8-1"></a>
## 8.1. Потенциальные группы
...
*Рисунок 15 — Пример разделения потенциальных групп.*

<a id="sec-8-2"></a>
## 8.2. Безопасное отключение потенциальной группы
...
<a id="sec-9"></a>
# 9. Диагностика, обслуживание и ремонтопригодность
...
<a id="sec-10"></a>
# 10. Программное обеспечение и конфигурирование
...
<a id="sec-12"></a>
# 12. Кибербезопасность и защита конфигурации
...
<a id="sec-13"></a>
# 13. Условия эксплуатации, хранения и утилизации
...
<a id="sec-14"></a>
# 14. Оценка принятых технических решений
...
<a id="sec-16"></a>
# 16. Перечень использованных документов
